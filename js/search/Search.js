...
export default class Search {
	...
	static searchMainInput(value) {
		...
		// Méthode filter: remplit "recipesMatched" avec les recettes de "recipes" sélectionnées si input est dans nom/description/ingrédients
		recipes.filter((recipe) => {
			if (
				...
				recipe.ingredients.some((elt) =>
					Utils.normalizeText(elt.ingredient).includes(Utils.normalizeText(value))
				)
			) 
			{
